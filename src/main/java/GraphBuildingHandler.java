...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    private ArrayDeque<Long> possibleNodes = new ArrayDeque<>();
...
//            System.out.println("Id of a node in this way: " + attributes.getValue("ref"));
            ...
            possibleNodes.add(Long.parseLong(attributes.getValue("ref")));
...
//                System.out.println("Max Speed: " + v);
                activeState.equals("node");
                //(optional) set the max speed of the "current way" here.
...
//            System.out.println("Finishing a way...");
            if (validWay) {
                lastNode = possibleNodes.getFirst();
                while (possibleNodes.size() > 0) {
                    currNode = possibleNodes.removeFirst();
                    if (currNode != lastNode) {
                        g.addEdge(currNode, lastNode);
                    }
                    lastNode = currNode;
                }
            }
